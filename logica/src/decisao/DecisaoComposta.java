...
public class DecisaoComposta {
	...
	public static void main(String[] args) {
		...
		if (qtde >= 10 && qtde <= 20)
		{
			System.out.println(produto + " Está com o estoque normal.");

		} 
		else if (qtde < 10)
		{
			System.out.println(produto + " Está com o estoque baixo!");
		} else 
		{
			System.out.println(produto + " Está com o estoque alto!");
		}
