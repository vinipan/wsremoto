...
public class Lista2Exec4 {
	...
	public static void main(String[] args) {
		int valorA = Integer.parseInt(JOptionPane.showInputDialog("1º valor:"));
		int valorB = Integer.parseInt(JOptionPane.showInputDialog("2º valor:"));
		int valorC = Integer.parseInt(JOptionPane.showInputDialog("3º valor:"));
